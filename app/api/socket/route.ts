...
// Define socket server type for TypeScript
interface ServerIOInstance extends ServerIO {
  _instance?: ServerIOInstance;
}

// Global instance of Socket.io server with proper type
let io: ServerIOInstance;
...
export async function GET(req: Request) {
  try {
    if (!io) {
      ...
      // Store the socket server instance for reuse
      io._instance = io;
